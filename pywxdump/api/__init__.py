...
def start_server(port=5000, online=False, debug=False, isopenBrowser=True, isopenflask=True,
    ...
    if isopenflask:
        ...
        config = uvicorn.Config(app=app, host=host, port=port, reload=debug, log_level="info", workers=1,
                                env_file=env_file)
